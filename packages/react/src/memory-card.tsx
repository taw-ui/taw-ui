...
import {
  MemoryCard as MemoryCardContract,
  type MemoryCardData,
  type MemoryItemData,
  type MemoryCategory,
  type TawToolPart,
...
// ─── Inline icons (10px, stroke-based) ───────────────────────────────────────
...
export function MemoryCard({
  ...
  const result = MemoryCardContract.parse(output)
  if (!result.success) {
